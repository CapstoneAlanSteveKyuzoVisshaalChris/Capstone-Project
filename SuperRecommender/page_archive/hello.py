...
def index():
    if 'username' in session:
        ...
        return x + '''<form method="post"> <p><input type=submit value=Logout href="http://google.com"> </form>'''

    return 'You are not logged in' + '''<form method="post"> <p><input type=submit value=Login href="http://google.com"> </form>'''
