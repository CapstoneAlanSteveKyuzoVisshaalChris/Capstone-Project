        ...
        if output[0]["text"] == "ACTORLIKE":
            for word in response["output"]["entities"]:
                if word.get("entity") == "actornames":
                    ...
                    print(
                        "Tell me the actor's/actresses' name and if you like/dislike them. Type \"return\" to go back, or \"list\" to see a list of your preferences.")
            ...
            for word in response["output"]["entities"]:
                if word.get("entity") == "genre":
                    ...
                    print(
                        "Tell me the genre name and if you like/dislike them. Type \"return\" to go back, or \"list\" to see a list of your preferences.")
            ...
            for word in response["output"]["entities"]:
                if word.get("entity") == "genre":
                    ...
                    print(
                        "Tell me the genre and if you like/dislike them. Type \"return\" to go back, or \"list\" to see a list of your preferences.")
